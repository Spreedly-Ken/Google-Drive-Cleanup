...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        target_directory = '/Users/ken/Library/CloudStorage/GoogleDrive-ken@spreedly.com/Shared drives/LEGAL/COMMERCIAL & BUSINESS SUPPORT/1. Customer Contracts'
        print(f"No directory provided. Using default: {target_directory}")
        
    output_csv = 'source_contracts_inventory.csv'
